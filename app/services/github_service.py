...
class GitHubService:
    ...
    def comment_session_started(self, issue_number: int, session_url: str):
        body = (
    ...
    def comment_session_completed(self, issue_number: int, pr_url: Optional[str], session_url: str):
        if pr_url:
            body = (
    ...
    def comment_session_failed(self, issue_number: int, session_url: str, error: Optional[str] = None):
        body = (
